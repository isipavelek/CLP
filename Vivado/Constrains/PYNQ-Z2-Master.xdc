...
#set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports {led1}]; led3#IO_L6N_T0_VREF_34 Sch=led[0]
...
set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports {enable}]; #IO_L4N_T0_35 Sch=btn[1]
set_property -dict { PACKAGE_PIN L20   IOSTANDARD LVCMOS33 } [get_ports {RW}]; #IO_L9N_T1_DQS_AD3N_35 Sch=btn[2]
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { busy }]; #IO_L5P_T0_34 Sch=ar[0]
...
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { scl }]; #IO_L24N_T3_34 Sch=ar_scl
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { sda }]; #IO_L24P_T3_34 Sch=ar_sda
